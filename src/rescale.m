function rescale(path_incoming, path_processed, base_str, mc,bc,m,b, r_mc,r_bc,r_m,r_b)
    ...
    shifted_height= shifted_approach_height;
    ...
    shifted_height= shifted_retract_height;
